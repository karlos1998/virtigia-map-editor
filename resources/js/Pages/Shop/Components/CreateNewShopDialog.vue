...
<template>
    <Dialog v-model:visible="visible" modal header="Tworzenie sklepu" :style="{ width: '25rem' }">
        <span class="text-surface-500 dark:text-surface-400 block mb-8">Podaj nazwę własną sklepu. Jest to tylko nazwa informacyjna czego dotyczy sklep, np. "Podstawowe itemy", "Roan" itp.</span>
