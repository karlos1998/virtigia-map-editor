...
import BaseItemAdvancedFilters, {
    type BaseItemFilters,
    type LegendaryBonusOption,
    type ShopOption,
} from './Components/BaseItemAdvancedFilters.vue';
...
<template>
    <AppLayout>
        <div class="card">
            <BaseItemAdvancedFilters
                :filters="filters"
                :selected-shop-options="selectedShopOptions"
                :legendary-bonus-options="legendaryBonusOptions"
                :attribute-point-options="attributePointOptions"
                :manual-attribute-point-options="manualAttributePointOptions"
                :is-loading-attribute-point-options="isLoadingAttributePointOptions"
            />
