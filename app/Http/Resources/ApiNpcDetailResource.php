...
#[OA\Schema(
    schema: ApiNpcDetailResource::class,
    type: 'object',
    properties: [
...
class ApiNpcDetailResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'locations' => ApiNpcLocationResource::collection($this->whenLoaded('locations')),
        ];
    }
}
