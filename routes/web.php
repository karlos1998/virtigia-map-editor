...
use App\Http\Controllers\MapTrackCheckpointController;
use App\Http\Controllers\MapTrackController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('api-tokens/{apiToken}', [ApiTokenController::class, 'update'])->name('api-tokens.update');
            ...
            ::middleware([
                ...
                ->group(function () {
                    ...
                    Route::withoutMiddleware(ValidateCsrfToken::class)->group(function () {
                        ...
                        Route::post('dialogs/{dialog}/nodes/{dialogNode}/options/order', [DialogController::class, 'updateOptionsOrder'])->name('dialogs.nodes.options.order');
                    ...
                    Route::get('map-tracks', [MapTrackController::class, 'index'])->name('map-tracks.index');
                    Route::get('map-tracks/create', [MapTrackController::class, 'create'])->name('map-tracks.create');
                    Route::post('map-tracks', [MapTrackController::class, 'store'])->name('map-tracks.store');
                    Route::get('map-tracks/{mapTrack}/edit', [MapTrackController::class, 'edit'])->name('map-tracks.edit');
                    Route::patch('map-tracks/{mapTrack}', [MapTrackController::class, 'update'])->name('map-tracks.update');
                    Route::delete('map-tracks/{mapTrack}', [MapTrackController::class, 'destroy'])->name('map-tracks.destroy');
                    Route::post('map-tracks/{mapTrack}/checkpoints', [MapTrackCheckpointController::class, 'store'])->name('map-tracks.checkpoints.store');
                    Route::patch('map-tracks/{mapTrack}/checkpoints/{checkpoint}', [MapTrackCheckpointController::class, 'update'])->name('map-tracks.checkpoints.update');
                    Route::patch('map-tracks/{mapTrack}/checkpoints/{checkpoint}/move', [MapTrackCheckpointController::class, 'move'])->name('map-tracks.checkpoints.move');
                    Route::delete('map-tracks/{mapTrack}/checkpoints/{checkpoint}', [MapTrackCheckpointController::class, 'destroy'])->name('map-tracks.checkpoints.destroy');
                    ...
                    Route::patch('maps/{map}/grouping-locked', [MapController::class, 'updateGroupingLocked'])->name('maps.update.grouping-locked');
                    ...
                    Route::post('base-items/bulk/base-npc-loots', [BaseItemController::class, 'bulkAttachToBaseNpcLoots'])->name('base-items.bulk.base-npc-loots.attach');
                    Route::post('base-items/bulk/shop-items', [BaseItemController::class, 'bulkAttachToShop'])->name('base-items.bulk.shop-items.attach');
                    Route::delete('base-items/bulk/relations', [BaseItemController::class, 'bulkDetachRelations'])->name('base-items.bulk.relations.detach');
                    Route::patch('base-items/bulk/properties', [BaseItemController::class, 'bulkUpdate'])->name('base-items.bulk.properties.update');
                    ...
                    Route::get('books/{book}/fetch', [BookController::class, 'fetch'])->name('books.fetch');
